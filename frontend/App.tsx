...
const games = [
  ...
  { name: 'SURVIVAL', id:"survival", color: 'from-green-400 to-green-600', img:"./images/missile-battle.svg"}, 
  { name: 'BALON SIEGE', id:"balon-siege", color: 'from-red-400 to-red-600', img:"./images/balon-siege.png"}
