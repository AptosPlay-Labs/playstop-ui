...
import { GameLogic, GameState, Player } from './games-modules/DinamiteGame/GameLogic';
...
//   const gameState = dinamiteStore(state => state.gameState);
  ...
  const handleKeyDown = useCallback((e: KeyboardEvent) => {
    ...
    //   mGameLogic.updatePlayerPosition(data?.id, data.x, data.y, data.angle);
            ...
            player.id === data.id ? { ...player, x:data.id, y:data.y, angle:data.angle } : player
            );
